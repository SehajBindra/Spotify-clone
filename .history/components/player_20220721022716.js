...
function player() {
  ...
  }, [useRecoilState(currentTrackIdState), useSpotify, useSession]);
  return (
    <div className="h-24 bg-gradient-to-b from-black to bg-gray-900 text-white grid grid-cols-3  text-xs md:text-base px-2 md:px-8">
      ...
      <div className="flex items-center justify-end  space-x-2 md:space-x-4  pr-5">
        ...
        />
        <input
          className="moz-range-thumb  bg-white appearance-none  cursor-pointer  h-0.5  hover:bg-green-500 rounded outline-none  w-14 md:w-28 "
          type="range"
          value={volume}
