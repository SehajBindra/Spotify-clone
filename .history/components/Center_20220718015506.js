...
function Center() {
  ...
  return (
    <div className=" flex-grow text-white h-screen overflow-y-scroll scrollbar-hide">
      <header className=" flex flex-1 justify-end space-x-8 absolute top-4 right-8">
        <div className="flex  items-middle   ">
          <HiMenuAlt1 className=" text-green-500 flex h-10 w-10 cursor-pointer justify-start  " />
        </div>
