  ...
  return (
    <div className="h-24 bg-gradient-to-b from-black to bg-gray-900 text-white grid grid-cols-3  text-xs md:text-base px-2 md:px-8">
      ...
      <div className="flex items-center justify-center  space-x-6">
        ...
        <RiRepeat2Fill className="h-5 w-5  text-green-500 cursor-pointer hover:scale-125 transition transform duration-100  ease-out " />
        <div className="flex items-end justify-items-end  space-x-6">
