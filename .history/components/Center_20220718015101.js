...
function Center() {
  ...
  return (
    <div className=" flex-grow text-white h-screen overflow-y-scroll scrollbar-hide">
      <header className=" flex justify-evenly space-x-8 absolute top-4 right-8">
        <div className="flex  justify-end bg-transparent   align-middle   ">
          <HiMenuAlt1 className=" flex h-10 w-10 cursor-pointer justify-start  " />
        </div>
